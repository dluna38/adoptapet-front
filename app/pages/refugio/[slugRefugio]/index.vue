          ...
          <div class="lg:w-2/3">
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
              ...
              <div class="flex items-center mb-2">
                ...
                <span class="text-orange-600">{{ refugio.ubicacionMunicipio.nombre +", "+refugio.ubicacionMunicipio.departamento.nombre }}</span>
              </div>
              <div class="flex items-center mb-2">
              ...
              <div class="flex items-center">
                ...
                <a :href="'mailto:' + refugio.correo" class="text-orange-600 hover:underline">{{ refugio.correo }}</a>
              </div>
            </div>
